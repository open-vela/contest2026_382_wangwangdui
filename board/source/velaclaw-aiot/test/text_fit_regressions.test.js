...
assert.strictEqual(launcher.layout.circle.surface, 'paged-list', 'Circle launcher must use the lightweight single-column list')
assert.strictEqual(launcher.layout.rect.surface, 'paged-list', 'Rect launcher must use the lightweight single-column list')

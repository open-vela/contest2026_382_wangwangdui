...
export function createClockController(onChange, onNotification) {
  ...
  return {
    ...
    start: function () {
      ...
      ensurePowerRuntime()
      refreshActivity()
      applyFace(watchfaceStore.getSelectedFaceId())
      updateTime()
    ...
    refreshSelectedFace: function () {
      applyFace(watchfaceStore.getSelectedFaceId())
      return emit()
    },
    markFaceSelectorEntry: function (callback) {
      watchfaceStore.markRightFaceTransition(selectedFaceId, callback)
    },
